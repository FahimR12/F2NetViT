...
def random_spatial_brats_augmentation(image, label, confg_path=r'C:\Users\fahim\Documents\Research_project\F2NetViT\config\config.yaml'):
...
def random_intensity_brats_augmentation(image, confg_path=r'C:\Users\fahim\Documents\Research_project\F2NetViT\config\config.yaml'):
...
def random_augment(image, label, confg_path=r'C:\Users\fahim\Documents\Research_project\F2NetViT\config\config.yaml'):
    """
    Parameters
    ----------
    image: torch tensor (n, c, d, h, w)
...
def patch_cropper(image, label, confg_path=r'C:\Users\fahim\Documents\Research_project\F2NetViT\config\config.yaml'):
    """
    Parameters
    ----------
    image: torch tensor (n, c, d, h, w)
